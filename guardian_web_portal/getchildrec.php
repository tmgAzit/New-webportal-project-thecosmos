...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    ...
    $sql = "SELECT child_profile.child_id, child_profile.first_name, absent_data.reason, absent_data.file
            FROM absent_data
            JOIN `child_profile` ON absent_data.child_id = child_profile.child_id ORDER BY absent_data.id DESC;";
